...
REM
REM Generated by Vivado on Mon Apr 18 17:32:24 +0300 2022
...
echo "xvlog --incr --relax -prj simulare_16_vlog.prj"
call xvlog  --incr --relax -prj simulare_16_vlog.prj -log xvlog.log
