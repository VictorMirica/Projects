...
--               c:/Users/student/Desktop/Emanuel/project3/project3.gen/sources_1/bd/design_1/ip/design_1_afisare_7seg_0_0/design_1_afisare_7seg_0_0_sim_netlist.vhdl
...
entity design_1_afisare_7seg_0_0_afisare_7seg is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_afisare_7seg_0_0_afisare_7seg : entity is "afisare_7seg";
end design_1_afisare_7seg_0_0_afisare_7seg;

architecture STRUCTURE of design_1_afisare_7seg_0_0_afisare_7seg is
  ...
  signal Seg_0 : STD_LOGIC_VECTOR ( 0 to 6 );
  ...
  attribute SOFT_HLUTNM of \Seg[0]_i_6\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Seg[0]_i_7\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Seg[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Seg[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Seg[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Seg[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Seg[5]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Seg[6]_i_1\ : label is "soft_lutpair0";
begin
...
\Seg[0]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\Seg[0]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity design_1_afisare_7seg_0_0 is
  ...
  attribute NotValidForBitStream of design_1_afisare_7seg_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_afisare_7seg_0_0 : entity is "design_1_afisare_7seg_0_0,afisare_7seg,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_afisare_7seg_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_afisare_7seg_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_afisare_7seg_0_0 : entity is "afisare_7seg,Vivado 2021.2";
end design_1_afisare_7seg_0_0;

architecture STRUCTURE of design_1_afisare_7seg_0_0 is
...
inst: entity work.design_1_afisare_7seg_0_0_afisare_7seg
     port map (
      An(3 downto 0) => \^an\(3 downto 0),
