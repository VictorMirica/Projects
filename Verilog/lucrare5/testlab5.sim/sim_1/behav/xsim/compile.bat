...
REM
REM Generated by Vivado on Mon May 16 17:00:59 +0300 2022
...
echo "xvlog --incr --relax -prj simulare2_vlog.prj"
call xvlog  --incr --relax -prj simulare2_vlog.prj -log xvlog.log
